#!/usr/bin/env python3
"""Import great_lakes.xlsx sheet Jack into Jack's Firestore profile."""
...
OWNER_UID = "7rHTHVidJTbMpDGBleeiEFdfSJS2"
TEAM_ID = "great_lakes"
CHAIN_MIN_STORES = 5
MAX_TRAFFIC_NOTES = 2
...
def main():
    ...
    if existing_docs:
        raise SystemExit("Jack already has shops; aborting to avoid duplicates.")
