#!/usr/bin/env python3
"""Import great_lakes.xlsx sheet Vince into Vince's Firestore profile."""
...
OWNER_UID = "heZJFYA4IERr2b7TqPmvAnrctvJ2"
TEAM_ID = "great_lakes"
CHAIN_MIN_STORES = 5
MAX_TRAFFIC_NOTES = 2
...
def main():
    ...
    if existing_docs:
        raise SystemExit("Vince already has shops; aborting to avoid duplicates.")
